...
/**
 * Problem: You are developing an application for which you would like to obtain the current date, not including the time, to
 * display on a form.
 *
 * Solution: Make use of the Date-Time API to obtain the current date. The LocalDate class represents an ISO calendar in the
...
public class ObtainingTheCurrentDateWithoutTime {
    ...
    public static void main (String[] args){
        ...
        Clock clock = Clock.systemUTC();
        LocalDate dateClock = LocalDate.now(clock);

        System.out.println("Date Clock " + dateClock);
    }
}
