 ...
 *
 * How It Works The Date-Time API makes it easy to perform calculations on dates and times.
 * The LocalDate and LocalTime objects have calculation methods built right in,
 * so there is no more worrying about converting to different types of objects in order to perform calculations. T
 * he Date-Time API also allows easy access to the current date or time by enabling you to invoke the now() method on either of those objects.
 */
